...
/**
  ******************************************************************************
  * @file    language_classification.h
...
#ifndef AI_LANGUAGE_CLASSIFICATION_H
#define AI_LANGUAGE_CLASSIFICATION_H
#pragma once
...
/******************************************************************************/
#define AI_LANGUAGE_CLASSIFICATION_MODEL_NAME          "language_classification"
#define AI_LANGUAGE_CLASSIFICATION_ORIGIN_MODEL_NAME   "model_cnn"

/******************************************************************************/
#define AI_LANGUAGE_CLASSIFICATION_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_LANGUAGE_CLASSIFICATION_IN_NUM        (1)

AI_DEPRECATED
#define AI_LANGUAGE_CLASSIFICATION_IN \
  ai_language_classification_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_LANGUAGE_CLASSIFICATION_IN_SIZE { \
  AI_LANGUAGE_CLASSIFICATION_IN_1_SIZE, \
}
#define AI_LANGUAGE_CLASSIFICATION_IN_SIZE_BYTES { \
  AI_LANGUAGE_CLASSIFICATION_IN_1_SIZE_BYTES, \
}
#define AI_LANGUAGE_CLASSIFICATION_IN_1_HEIGHT      (625)
#define AI_LANGUAGE_CLASSIFICATION_IN_1_WIDTH       (12)
#define AI_LANGUAGE_CLASSIFICATION_IN_1_CHANNEL     (1)
#define AI_LANGUAGE_CLASSIFICATION_IN_1_SIZE        (625 * 12 * 1)
#define AI_LANGUAGE_CLASSIFICATION_IN_1_SIZE_BYTES  (7500)

/******************************************************************************/
#define AI_LANGUAGE_CLASSIFICATION_OUT_NUM       (1)

AI_DEPRECATED
#define AI_LANGUAGE_CLASSIFICATION_OUT \
  ai_language_classification_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_LANGUAGE_CLASSIFICATION_OUT_SIZE { \
  AI_LANGUAGE_CLASSIFICATION_OUT_1_SIZE, \
}
#define AI_LANGUAGE_CLASSIFICATION_OUT_SIZE_BYTES { \
  AI_LANGUAGE_CLASSIFICATION_OUT_1_SIZE_BYTES, \
}
#define AI_LANGUAGE_CLASSIFICATION_OUT_1_CHANNEL     (3)
#define AI_LANGUAGE_CLASSIFICATION_OUT_1_SIZE        (3)
#define AI_LANGUAGE_CLASSIFICATION_OUT_1_SIZE_BYTES  (3)

/******************************************************************************/
#define AI_LANGUAGE_CLASSIFICATION_N_NODES (13)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup language_classification
 ...
 * @ingroup language_classification
 ...
 * @ref ai_language_classification_create. Both the activations memory buffer 
 ...
 * using @ref ai_language_classification_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_language_classification_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_language_classification_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_LANGUAGE_CLASSIFICATION_*
 * defines into file @ref language_classification.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_language_classification_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_LANGUAGE_CLASSIFICATION_H */
